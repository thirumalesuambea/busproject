...
<link rel="stylesheet" type="text/css" href="css/css.css">
  ...
  <body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#loginModal">Login/Signup</a>
          </li>
    ...
    <h4 style="color: white;">No bus found according to your criteria.Please search again with different date or cities.</h4>
		   ...
		   <form action="login" method="post">
				...
				<div class="field">
					...
					<p class="control has-icons-left has-icons-right">
						<input class="input" name="username" type="text" placeholder="Username"> <span
			...
			<footer class="modal-card-foot">
				...
				<button class="signupToggle button is-success">Signup</button>
			</footer>
			</form>
		</div>
	</div>
		...
		<div class="modal-card">
			...
			<section class="modal-card-body">
				...
				<div class="field">
					...
					<div class="control has-icons-left has-icons-right">
						<input class="input is-success" type="text" name="username"
							placeholder="Text input" value="bulma"> <span
				...
				<div class="field">
					...
					<div class="control has-icons-left has-icons-right">
						<input class="input is-success" type="number" step="0.01" name="number"
							placeholder="Text input"> <span
				...
				<div class="field">
					...
					<p class="control has-icons-left has-icons-right">
						<input class="input" type="email" placeholder="Email" name="email"> <span
							class="icon is-small is-left"> <i class="fas fa-envelope"></i>
						</span> <span class="icon is-small is-right"> <i
							class="fas fa-check"></i>
						</span>
			...
			<footer class="modal-card-foot">
				<button class="button is-success" value="submit">Sign Up</button>
